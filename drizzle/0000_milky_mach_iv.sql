...
--> statement-breakpoint
CREATE TABLE "authVerificationTokens" (
...
ALTER TABLE "authAccounts" ADD CONSTRAINT "authAccounts_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "authAccounts_provider_idx" ON "authAccounts" USING btree ("provider","providerAccountId");--> statement-breakpoint
CREATE INDEX "authAccounts_user_id_idx" ON "authAccounts" USING btree ("user_id");--> statement-breakpoint
CREATE UNIQUE INDEX "authVerificationTokens_pk" ON "authVerificationTokens" USING btree ("identifier","token");--> statement-breakpoint
